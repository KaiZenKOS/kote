...
insert into public.marchand (
  ...
  repere, localisation, localisation_ajustee, statut, derniere_confirmation
) values
  (
    ...
    '+22890000101',
    'En face de la pharmacie du carrefour, premiere porte a gauche',
    st_setsrid(st_makepoint(1.2358, 6.1782), 4326)::geography,
    true, 'active', now() - interval '5 days'
  ),
  (
    ...
    '+22890000102',
    'Apres le carrefour, a cote du depot de ciment',
    st_setsrid(st_makepoint(1.2371, 6.1769), 4326)::geography,
    true, 'active', now() - interval '12 days'
  ),
  (
    ...
    '+22890000103',
    'Sous le grand manguier, en face de l''ecole primaire',
    st_setsrid(st_makepoint(1.2342, 6.1791), 4326)::geography,
    false, 'active', now() - interval '2 days'
  ),
  (
    ...
    '+22890000104',
    'Etage au-dessus de la boutique de telephones, entree par la cour',
    st_setsrid(st_makepoint(1.2366, 6.1795), 4326)::geography,
    true, 'active', now() - interval '40 days'
  ),
  (
    ...
    '+22890000105',
    'Deuxieme boutique apres le poste de police',
    st_setsrid(st_makepoint(1.2330, 6.1760), 4326)::geography,
    false, 'active', now() - interval '95 days'
  ),
  (
    ...
    '+22890000106',
    'Angle de la rue, kiosque bleu',
    st_setsrid(st_makepoint(1.2395, 6.1810), 4326)::geography,
    true, 'active', now() - interval '20 days'
  ),
  ...
  (
    ...
    '+22890000107',
    'Interieur du Grand Marche, allee des tissus',
    st_setsrid(st_makepoint(1.2231, 6.1301), 4326)::geography,
    true, 'active', now() - interval '8 days'
  );
